                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-sm-8 col-sm-offset-2" action="{{route('labratory.update',$edit->id)}}" enctype="multipart/form-data" method="post">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>" />
                                <input type="hidden" name="_method" value="PUT">
                                <div class="form-group">
                                    <label>Laboratory Name</label>
                                    <input type="text" class="form-control" name="name" placeholder="Enter Lab Name" value="{{$edit->name}}" required>
                                </div>
                                <div class="form-group">
                                    <label>Lab Address</label>
                                    <input type="text" class="form-control" name="address" placeholder="Enter Lab Address" value="{{$edit->address}}">
                                </div>
                                <div class="form-group">
                                    <label>Mobile</label>

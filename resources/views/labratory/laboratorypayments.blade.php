    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                ...
                <h1>Laboratory</h1>
                <small>Laboratory Payment</small>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-primary" href="{{route('labratory.index')}}">
                                    <i class="fa fa-list"></i>  Laboratory List </a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{route('laboratory_payment.store')}}" enctype="multipart/form-data" method="post">

...
<head>
    ...
    <title>Closed Appointments</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Appointment </h1>
                <small>Closed Appointments</small>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-success" href="{{route('appointment.create')}}"> <i class="fa fa-plus"></i>  Add Appointment</a>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    @foreach($closed_appointments as $appointment)
                                        <tr>
                                            <td>{{$loop->iteration}}</td>
                                            <td>{{ucfirst($appointment->patient->patient_name)}}</td>
                                            <td>0{{$appointment->patient->phone_number}}</td>

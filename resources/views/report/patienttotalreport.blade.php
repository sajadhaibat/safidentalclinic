...
<head>
    ...
    <title>Patient Total Report</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Report</h1>
                <small> Patient Total Report</small>
        ...
        <div class="filter-content">
            <div class="panel panel-bd lobidrag">
                <div class="panel-body">
                    <form class="form-inline" action="{{url('patienttotalreport')}}" enctype="multipart/form-data" method="post">

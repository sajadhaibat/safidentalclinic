...
<head>
    ...
    <title>Laboratory Payments Report</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                <h1>Report</h1>
                <small> Laboratory Payments Report</small>
        ...
        <div class="filter-content">
            <div class="panel panel-bd lobidrag">
                <div class="panel-body">
                    <form class="form-inline" action="{{url('laboratorypaymentsreport')}}" enctype="multipart/form-data" method="post">

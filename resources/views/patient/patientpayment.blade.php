                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{route('payment.store')}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="loan_amount" id="loan_amount" placeholder="Loan Amount" readonly required>
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if (data < 1) {
                        ...
                        document.getElementById("total_fee").readOnly = false;
                        $('#pay_amount').on('input',function(e){
                            $('#new_loan_amount').val( $('#total_fee').val() - $('#pay_amount').val());
                        });
                        $('#total_fee').on('input',function(e){
                            $('#new_loan_amount').val( $('#total_fee').val() - $('#pay_amount').val());
                        });
                    ...
                    if (data > 1){
                        ...
                        document.getElementById("total_fee").readOnly = true;
                        $('#pay_amount').on('input',function(e){
                            $('#new_loan_amount').val( $('#loan_amount  ').val() - $('#pay_amount').val());
                        });
                        $('#loan_amount').on('input',function(e){
                            $('#new_loan_amount').val( $('#loan_amount  ').val() - $('#pay_amount').val());
                        });
                        ...
                        console.log("lolll" + $('#loan_amount').val());
                    }
                },
                error:function(){

                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            <form class="col-sm-6" action="{{route('patient.store')}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="patient_fname" placeholder="Enter Patient Father Name">
                                </div>
                                <div class="form-group">
                                    <label>Mobile</label>
                                    <input type="number" class="form-control" name="phone_number" placeholder="Enter Mobile" >
                                </div>
                                <div class="form-group">
                                    <label>Address</label>
                                ...
                                <div class="form-group">
                                    <label>OPD</label><br>
                                    <label class="radio-inline"><input name="OPD" value="yes" checked="checked" type="radio">Yes</label>
                                    <label class="radio-inline"><input name="OPD" value="no" type="radio">No</label>

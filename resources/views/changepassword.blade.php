                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-primary" href="{{route('profile.create')}}">
                                    <i class="fa fa-list"></i> Change profile </a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <br>
                            <form class="col-sm-8 col-sm-offset-2" action="{{route('newpassword')}}" enctype="multipart/form-data" method="post">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>" />
                                <div class="form-group">
                                    <div class="{{ $errors->has('passwordold') ? ' has-error' : '' }}">

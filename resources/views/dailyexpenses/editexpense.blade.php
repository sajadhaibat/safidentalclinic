                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-primary" href="{{route('dailyexpense.index')}}">
                                    <i class="fa fa-list"></i>  Expense List </a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <form class="col-sm-8 col-sm-offset-2" action="{{route('dailyexpense.update',$edit->id)}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                    <label>Amount</label>
                                    <input type="number" class="form-control" name="amount" placeholder="Enter amount" value="{{$edit->amount}}">
                                </div>

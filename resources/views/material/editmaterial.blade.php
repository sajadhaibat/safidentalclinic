                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-primary" href="{{route('material.index')}}">
                                    <i class="fa fa-list"></i>  Material List </a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <form class="col-sm-8 col-sm-offset-2" action="{{route('material.update',$edit->id)}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="material" placeholder="Enter Material Name" value="{{$edit->material}}">
                                </div>
                                <div class="form-group">
                                    <label>Money Amount</label>
                                    <input type="number" class="form-control" name="amount" placeholder="Enter Money Amount" value="{{$edit->amount}}">
                                </div>

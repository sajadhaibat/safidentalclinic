                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-primary btn-list" href="#" data-toggle="modal" data-target="#modal-material"> <i class="fa fa-plus"></i> Add New Material</a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                                ...
                                <table id="dataTable" class="table table-bordered table-hover">
                                    ...
                                    @foreach($materials as $material)
                                        <tr>
                                            ...
                                            <td>{{ucfirst($material->staff->name)}}</td>
                                            <td>{{$material->material}}</td>
                                            <td>{{$material->amount}}</td>
                                            <td>{{$material->date}}</td>
                                            <td>{{$material->remark}}</td>
                                            <td><a type="button" class="btn btn-primary btn-outline w-sm" href="{{route('material.edit',$material->id)}}"><i class="fa fa-edit"></i></a></td>
                                            <td>
                            ...
                            <div class="modal fade modal-success" id="modal-material" tabindex="-1" role="dialog" style="display: none;">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                            <h1 class="modal-title">Add New Material</h1>
                                        </div>
                                        <div class="modal-body">
                                            <form action="{{route('material.store')}}" enctype="multipart/form-data" method="post" id="material_form">
                                                ...
                                                <div class="form-group" id="total_fee_div">
                                                    ...
                                                    <input type="number" class="form-control" name="amount" placeholder="Money Amount" required>
                                                </div>
                                                <div class="form-group">
                                                    <label> Date</label>

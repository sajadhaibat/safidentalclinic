    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title">
                ...
                <h1>Users</h1>
                <small>Change Users Profile</small>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a class="btn btn-primary" href="{{url('changeuserspassword')}}">
                                    <i class="fa fa-list"></i> Change users password </a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <br>
                            <form class="col-sm-8 col-sm-offset-2" action="{{route('usernewprofile')}}" enctype="multipart/form-data" method="post">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token() ?>" />
                                <div class="form-group text-center">
                                    <img src="//placehold.it/150" class="rounded-circle" alt="avatar">
